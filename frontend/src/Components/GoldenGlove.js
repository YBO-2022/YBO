  ...
  return (
    <div>
      ...
      <div className="glove_img">
          <div className="g_one"><span style={{paddingRight: "20%"}}>좌익수</span> <span style={{paddingRight: "20%"}}>중견수</span> 우익수</div>
          <div className="g_two"><span style={{paddingRight: "3%"}}>유격수</span> 2루수</div>
          <div className="g_three"><span style={{paddingRight: "31%"}}>3루수</span> 1루수</div>
